...
const docss = `
All the parameters written below all work, so please pay attention. This method is a method that can be customized, almost anything can be customized, the parameter behind it using "--example" is an optional parameter, this method uses rststream to cancel each request. greetings from @アレックス
...
Usage: node ez.js GET https://example.com/ 60 10 100 proxy.txt
`;
...
if (cluster.isMaster) {
    ...
    console.log(`
        ...
        \x1b[3;31;40m                    \x1b[1;37mAttack order sent by: @アレックス
